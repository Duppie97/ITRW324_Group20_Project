package com.example.jaco.chat_app_toetss.ui.fragments;
...
import com.example.jaco.chat_app_toetss.SignUpSingleton;
import com.example.jaco.chat_app_toetss.core.login.LoginContract;
import com.example.jaco.chat_app_toetss.core.login.LoginPresenter;
import com.example.jaco.chat_app_toetss.ui.activities.RegisterActivity;
import com.example.jaco.chat_app_toetss.ui.activities.UserListingActivity;
...
public class LoginFragment extends Fragment implements View.OnClickListener, LoginContract.View {
    ...
    private void bindViews(View view) {
        ...
        System.out.println("asbwerk" + mETxtEmail.getText().toString());
        SignUpSingleton.getInstance().setEmail(mETxtEmail.getText().toString());
    }
